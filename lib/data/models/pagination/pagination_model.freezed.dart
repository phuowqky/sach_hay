...
abstract class $PaginationModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {int? page, int? limit, int? total, int? totalPages, bool? hasMore});
}
...
class _$PaginationModelImpl implements _PaginationModel {
  ...
  @override
  String toString() {
    return 'PaginationModel(page: $page, limit: $limit, total: $total, totalPages: $totalPages, hasMore: $hasMore)';
  }
...
abstract class _PaginationModel implements PaginationModel {
  const factory _PaginationModel(
      ...
      final int? total,
      final int? totalPages,
      final bool? hasMore}) = _$PaginationModelImpl;
