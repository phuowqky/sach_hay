...
class _$RegisterModelImpl implements _RegisterModel {
  ...
  @override
  String toString() {
    return 'RegisterModel(phone: $phone, userName: $userName, email: $email, password: $password, confirmPassword: $confirmPassword)';
  }
...
abstract class _RegisterModel implements RegisterModel {
  const factory _RegisterModel(
      ...
      final String? email,
      final String? password,
      final String? confirmPassword}) = _$RegisterModelImpl;
