...
class _ApiService implements ApiService {
  ...
  @override
  Future<ApiResponse<LoginModel>> getUserProfile(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<UserModel>> getAvatar(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<ApiResponse<List<RankingModel>>> getRanking() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<List<RankingModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<List<RankingModel>> _value;
    try {
      _value = ApiResponse<List<RankingModel>>.fromJson(
        _result.data!,
        (json) => json is List<dynamic>
            ? json
                .map<RankingModel>(
                    (i) => RankingModel.fromJson(i as Map<String, dynamic>))
                .toList()
            : List.empty(),
      );
    } on Object catch (e, s) {
